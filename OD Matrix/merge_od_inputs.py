...
def main():
    ...
    parser.add_argument(
        "--points",
        default=str(base_dir / "final_CSV" / "points_with_locality_v2_final.csv")
    )
    parser.add_argument(
        "--polygons",
        default=str(base_dir / "final_CSV" / "multipolygons_with_locality_v2_final.csv")
    )
    parser.add_argument(
        "--outdir",
        default=str(base_dir / "OD_Outputs")
    )
